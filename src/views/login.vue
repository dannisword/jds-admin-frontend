            ...
            <div class="right-wrap">
                <el-form ref="loginForm" auto-complete="on" label-position="left" :model="data.user"
                    ...
                    <el-form-item prop="account">
                        <el-input ref="account" name="account" v-model="data.user.account" placeholder="帳號" type="text"
                            tabindex="1" auto-complete="on" prefix-icon="user" />
                    </el-form-item>

                    <el-form-item prop="password">
                        <el-input ref="password" name="password" v-model="data.user.password" :type="data.passwordType"
                            :key="data.passwordType" prefix-icon="lock" placeholder="密碼" tabindex="2" auto-complete="on"
                    ...
                    <el-button :loading="data.loading" type="primary" style="width: 100%; margin-bottom: 30px"
