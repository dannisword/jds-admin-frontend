...
<template>
    <el-container v-loading="state.container.isLoading" :element-loading-text="state.container.message">
        <div class="wrap">
            <table>
                <tr>
                ...
                <tr>
                    <td>Stage</td>
                    <td> <el-form-item :rules="[{ required: true, trigger: 'blur' }]"
                ...
                <tr>
                    ...
                    <td>Gerber Out Date</td>
                    <td> <el-form-item>
                            <el-date-picker v-model="entity.startDate"> </el-date-picker>
                        </el-form-item></td>
                </tr>
                <tr>
                    <th colspan="4">Data Release Date</th>
                </tr>
                <tr>
                    <td>EF</td>
                    <td>
        ...
        <!-- <el-main> -->
            <!-- <h3>Project info</h3> -->
            <!-- <el-form ref="refForm" label-width="auto" auto-complete="on" :inline="false">
                <el-row> -->
